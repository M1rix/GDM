...
class CurrencyResourceIT {
    ...
    private static final CurrencyStatus DEFAULT_STATUS = CurrencyStatus.ACTIVE;
    private static final CurrencyStatus UPDATED_STATUS = CurrencyStatus.INACTIVE;
    ...
    void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.getCountryFlag()).isEqualTo(DEFAULT_COUNTRY_FLAG);
        assertThat(testCurrency.getPosition()).isEqualTo(DEFAULT_POSITION);
    ...
    @Test
    @Transactional
    void checkCountryFlagIsRequired() throws Exception {
        int databaseSizeBeforeTest = currencyRepository.findAll().size();
        // set the field null
        currency.setCountryFlag(null);
    ...
    void putNewCurrency() throws Exception {
        ...
        assertThat(testCurrency.getCountryFlag()).isEqualTo(UPDATED_COUNTRY_FLAG);
        assertThat(testCurrency.getPosition()).isEqualTo(UPDATED_POSITION);
